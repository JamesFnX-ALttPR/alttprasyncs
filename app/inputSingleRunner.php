...
echo ' /></td></tr>' . PHP_EOL;
echo '            <tr><td><label for="racer1VOD" title="Provide a full link to your VOD, starting with https://.">Link to VOD: </label></td><td><input type="text" id="racer1VOD" name="racer1VOD"';
