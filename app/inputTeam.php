...
echo '        </thead>' . PHP_EOL;
echo '        <tbody>' . PHP_EOL;
echo '            <tr><td><label for="teamName">Team Name: </td><td colspan="2"><input type="text" size="47" id="teamName" name="teamName" ';
...
echo '/></td></tr>' . PHP_EOL;
echo '            <tr class="timeInput"><td><label for="racer1IGTHours" title="Your time from the credits screen. Leave blank if not a single-segment run.">In-Game Times: </label></td><td><input type="number" id="racer1IGTHours" name="racer1IGTHours" min="0" max="24" placeholder="HH" ';
...
echo '/></td><td><input type="number" id="racer2IGTHours" name="racer2IGTHours" min="0" max="24" placeholder="HH" ';
if(isset($_POST['racer2IGTHours'])) {
    echo 'value="' . $_POST['racer2IGTHours'] . '" ';
}
echo '/>:<input type="number" id="racer2IGTMinutes" name="racer2IGTMinutes" min="0" max="59" placeholder="MM" ';
if(isset($_POST['racer2IGTMinutes'])) {
    echo 'value="' . $_POST['racer2IGTMinutes'] . '" ';
}
echo '/>:<input type="number" id="racer2IGTSeconds" name="racer2IGTSeconds" min="0" max="59" placeholder="SS" ';
if(isset($_POST['racer2IGTSeconds'])) {
    echo 'value="' . $_POST['racer2IGTSeconds'] . '" ';
}
echo '/></td></tr>' . PHP_EOL;
