...
echo '                    <tr><td><label for="searchRange" title="Number of days you\'d like to search by default. Input 0 if you want to search the entire database by default.">Default Search Range:</label></td><td><input type="number" id="searchRange" nae="searchRange" min="0" value="' . $currentOffset . '" required /><td></tr>' . PHP_EOL;
