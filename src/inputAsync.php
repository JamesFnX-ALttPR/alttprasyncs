...
?>
                    ...
                    <tr><td colspan="2"><select id="hash1" name="hash1" required>
<?php
createHashDropdown();
?>
                    </select> <select id="hash2" name="hash2" required>
<?php
createHashDropdown();
?>
                    </select> <select id="hash3" name="hash3" required>
<?php
createHashDropdown();
?>
                    </select> <select id="hash4" name="hash4" required>
<?php
createHashDropdown();
?>
                    </select> <select id="hash5" name="hash5" required>
<?php
createHashDropdown();
?>
                    </select></td></tr>
