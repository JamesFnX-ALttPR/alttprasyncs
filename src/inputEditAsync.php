...
?>
                    ...
                    <tr class="spoiler"<?php if ($race_spoiler_flag == 'y') { echo ' style="display: table-row;"'; } ?>><th class="rightAlign"><label for="spoilerLog" title="Include the entire URL for the seed\'s spoiler log, starting with https://">Link to Spoiler Log: </th><td class="centerAlign"><input type="text" size="46" id="spoilerLog" name="spoilerLog" value="<?= $race_spoiler_link ?>" /></td></tr>
