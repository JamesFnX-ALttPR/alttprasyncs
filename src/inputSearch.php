...
createHashDropdown();
echo '                </select>' . PHP_EOL;
echo '                <select id="hash2" name="hash2">' . PHP_EOL;
createHashDropdown();
echo '                </select>' . PHP_EOL;
echo '                <select id="hash3" name="hash3">' . PHP_EOL;
createHashDropdown();
echo '                </select>' . PHP_EOL;
echo '                <select id="hash4" name="hash4">' . PHP_EOL;
createHashDropdown();
echo '                </select>' . PHP_EOL;
echo '                <select id="hash5" name="hash5">' . PHP_EOL;
createHashDropdown();
echo '                </select>' . PHP_EOL;
echo '            </td></tr>' . PHP_EOL;
